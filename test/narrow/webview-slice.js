...
;(() => {
  ...
  ;(async () => {
    try {
      ...
      if (q('slots').querySelector('input,select')) throw new Error('slots-editable')
      ...
      if (!text('slot-detail').includes('Smoke permanent') || !text('slot-detail').includes('^!#1')) throw new Error('permanent-config')
      q('slot-5').click()
