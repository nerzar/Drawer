...
class Slots {
    ...
    ;  4. постоянные привязки восстанавливаются из снимка и только при
    ;     неизменных exe/cls. Изменилась identity или слот перестал быть
    ;     постоянным — окно возвращается на исходное место.
